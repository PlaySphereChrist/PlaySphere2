      ...
      <div className="w-full max-w-md space-y-6 relative">
        ...
        >
          ...
          <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
            {message && (
              <div style={{ background: '#E7F6EC', color: '#166534' }} className="rounded-lg p-3 text-sm">
                {message}
              </div>
            )}
            {error && (
              <div style={{ background: '#FDECEC', color: '#B91C1C' }} className="rounded-lg p-3 text-sm">
                {error}
              </div>
            )}
            ...
            <div className="text-sm text-center pt-1">
              <span style={{ color: '#7A6552' }}>Don&apos;t have an account? </span>
              <Link to="/signup" style={{ color: '#6F4E37' }} className="font-medium hover:underline">
                Sign up
              </Link>
            </div>
          </form>
